...
def main() -> None:
    ...
    w("---")
    w()
    w("*Relatório gerado por `scripts/report_parquet_schema_vs_sql.py`. Execute após extrair Parquets com `python -m python.local_lab.extract_bigquery_to_parquet`.*")
